...
<head>
    ...
    <title>Ingrediente + Receita</title>
        ...
        <div class="container-fluid content-top-gap">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb my-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ingrediente + Receita</li>
                </ol>
            </nav>
            <!-- //breadcrumbs -->
            <!-- forms -->
            <section class="forms">
                ...
                <div class="card card_border py-2 mb-4">
                    <div class="cards__heading">
                        <h3>Ingrediente + Receita<span></span></h3>
                    </div>
                    <div class="card-body">
                            ...
                            <table border="2">
                                ...
                                <tr>
                                    ...
                                    foreach($pdo->query($sql)as $row)
                                    {
                                        ...
                                        echo '<td width=90 height=60>';
                                        echo '<a class="btn btn-warning" href="addIngrediente.php?id='.$row['id'].'">Adicionar Ingrediente</a>';
                                        echo '</td>';
                                        echo '</tr>';
                                    }
                                    Banco::desconectar();
