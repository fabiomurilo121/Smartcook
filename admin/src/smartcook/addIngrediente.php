                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-2">
                                <h5>Ingredientes ja adicionados</h5>
                                <table border="2">
                                    <tr>
                                        <th>ID</th>
                                        <th>Nome</th>
                                    ...
                                    <tr>
                                        ...
                                        try {
                                            ...
                                            $stmt = $pdo->prepare("SELECT ingredientId FROM ingredientrecipes WHERE recipeId = $id");
                            ...
                            <form method="post" action="processaIngRec.php?id=<?php echo $id; ?>">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    foreach ($pdo->query($sql) as $ingredients) {
                                        ?>
                                        <option value="<?php echo $ingredients['id']; ?>"><?php echo $ingredients['name']; ?></option>
                                        <?php
                                    }
                                    Banco::desconectar();
                                    ?>
