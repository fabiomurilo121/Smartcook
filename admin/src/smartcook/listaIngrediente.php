        ...
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Lista ingredientes<span></span></h3>
                </div>
                <div class="card-body">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                foreach($pdo->query($sql)as $row)
                                {
                                    ...
                                    echo '<td width=180>';
                                    echo '<a class="btn btn-warning" href="editarIngrediente.php?id='.$row['id'].'">Atualizar</a>';
                                    echo ' ';
                                    echo '<a class="btn btn-danger" href="deleteIngrediente.php?id='.$row['id'].'">Excluir</a>';
                                    echo '</td>';
                                    echo '</tr>';
                                }
                                Banco::desconectar();
