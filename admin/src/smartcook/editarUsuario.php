                        ...
                        <form action="" method="post">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="email" name="email" class="form-control input-style" placeholder="Email" value="<?php echo !empty($email)?$email:'';?>">
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="input__label">Senha</label>
                                    <input type="text" name="senha" class="form-control input-style" placeholder="Senha" value="<?php echo !empty($senha)?$senha:'';?>">
                                </div>
                            </div>
