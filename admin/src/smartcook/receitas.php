...
if(!empty($_POST))
{
    ...
    if($validacao)
    {
        ...
        $sql = "INSERT INTO recipes (name,description,preparationMethod,totalMinutes,serves,link) VALUES(?,?,?,?,?,?)";
        $q = $pdo->prepare($sql);
        $q->execute(array($nome,$descricao,$modoPreparo,$totalMinutos,$server,$link));
        Banco::desconectar();
...
<section>
    ...
    <div class="sidebar-menu sticky-sidebar-menu">
        ...
        <!-- logo start -->
        <div class="logo">
            <h1><a href="admin.php">SmartCook</a></h1>
        </div>

        <div class="logo-icon text-center">
            <a href="admin.php" title="logo"><img src="../../assets/dashboard-assets/images/logo.png" alt="logo-icon"> </a>
        </div>
        <!-- //logo end -->
                    ...
                    <form action="#" method="post">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="modoPreparo" class="form-control input-style" placeholder="Modo de Preparo">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="input__label">Total de minutos</label>
                                <input type="text" name="totalMinutos" class="form-control input-style" placeholder="Total de minutos">
                            </div>
                        </div >
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label class="input__label">Serve quantas Pessoas</label>
                                <input type="text" name="server" class="form-control input-style" placeholder="Serve quantas Pessoas">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="input__label">Link da Imagem</label>
                                <input type="text" name="link" class="form-control input-style" placeholder="Link da Imagem">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="input__label">descrição</label>
                                <textarea name="descricao" class="form-control input-style" rows="4" cols="50"></textarea>
                            </div>
                        </div >
