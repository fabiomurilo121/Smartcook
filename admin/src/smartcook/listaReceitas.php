...
<section>
  ...
  <div class="sidebar-menu sticky-sidebar-menu">
    ...
    <!-- logo start -->
    <div class="logo">
      <h1><a href="../../assets/index.php">SmartCook</a></h1>
    </div>

    <div class="logo-icon text-center">
      <a href="../../assets/index.php" title="logo"><img src="../../assets/dashboard-assets/images/logo.png" alt="logo-icon"> </a>
    </div>
    <!-- //logo end -->
    ...
    <div class="container-fluid content-top-gap">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb my-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lista de Receitas</li>
            </ol>
        </nav>
        <!-- //breadcrumbs -->
        <!-- forms -->
        <section class="forms">
            ...
            <div class="card card_border py-2 mb-4">
                <div class="cards__heading">
                    <h3>Lista Receitas<span></span></h3>
                </div>
                <div class="card-body">
                  <form action="#" method="post">
                    <table border="2">
                        <tr>
                            ...
                            <th>Server quantas Pessoas</th>
                            <th><img src="../../assets/dashboard-assets/images/ui.png"></th>
                            <th>Ações</th>
                        </tr>
                            <tr>
                                <?php
                                ...
                                foreach($pdo->query($sql)as $row)
                                {
                                    ...
                                    echo '<td>'. $row['preparationMethod'] . '</td>';
                                    echo '<td>'. $row['totalMinutes'] . '</td>';
                                    echo '<td>'. $row['serves'] . '</td>';
                                    echo '<td>'. $row['link'] . '</td>';


                                    echo '<td width=180>';
                                    echo '<a class="btn btn-warning" href="editarReceita.php?id='.$row['id'].'">Atualizar</a>';
                                    echo ' ';
                                    echo '<a class="btn btn-danger" href="deleteReceita.php?id='.$row['id'].'">Excluir</a>';
                                    echo '</td>';
                                    echo '</tr>';
                                }
                                Banco::desconectar();
