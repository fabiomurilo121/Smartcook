    ...
    <section class="slide slide-one">
      <div class="container">
        ...
        <div class="banner-text col-lg-5">
          <h5>SmartCook <br>feito para você</h5>
          <p>Use imagens para adicionar seus ingredientes e facilitar a sua busca</p>
          <a href="listaReceita.php" class="btn logo-button top-margin">Testar Agora</a>
          <h6 class="para">Experimente uma <strong>demonstração gratuita </strong>com todos os recursos.</h6>
        </div>
        <div class="image-postion col-lg-7">
          <img src="assets/assets-dashboard/images/foto.jpg" alt="product" class="img-responsive banner-images">
        </div>
